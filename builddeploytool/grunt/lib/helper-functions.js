        ...
        target: {
            options: {
                ...
                then: function(results, done) {
                    if (results.username) {
                        grunt.config("apigee_profiles." + grunt.option('env') + ".username", results.username);
                    }
                    if (results.password) {
                        grunt.config("apigee_profiles." + grunt.option('env') + ".password", results.password);
                    }
                    done();
                    return true;
                }
